...
<head>
	...
	<body>
		...
		<section class="home-slider owl-carousel">
			<div class="slider-item" style="background-image: url('http://localhost/expresscode/page/assets/templates/default/frontend/images/bg_1.jpg');">
			...
			<div class="slider-item" style="background-image: url('http://localhost/expresscode/page/assets/templates/default/frontend/images/bg_2.jpg');">
				<div class="overlay"></div>
				<div class="container">
					<div class="row slider-text align-items-center" data-scrollax-parent="true">
						<div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		...
		<section class="ftco-section ftco-services">
			...
			<div class="container-wrap mt-5">
				<div class="row d-flex no-gutters">
					<div class="col-md-6 img" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/about-2.jpg);">
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
						<div class="staff">
							<div class="img mb-4" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/person_5.jpg);"></div>
					...
					<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
						<div class="staff">
							<div class="img mb-4" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/person_6.jpg);"></div>
							<div class="info text-center">
					...
					<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
						<div class="staff">
							<div class="img mb-4" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/person_7.jpg);"></div>
							<div class="info text-center">
					...
					<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
						<div class="staff">
							<div class="img mb-4" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/person_8.jpg);"></div>
							<div class="info text-center">
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/bg_1.jpg);" data-stellar-background-ratio="0.5">
			<div class="container">
						...
						<div class="carousel-testimony owl-carousel ftco-owl">
							<div class="item">
								<div class="testimony-wrap p-4 pb-5">
									<div class="user-img mb-5" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/person_1.jpg)">
							...
							<div class="item">
								<div class="testimony-wrap p-4 pb-5">
									<div class="user-img mb-5" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/person_2.jpg)">
										<span class="quote d-flex align-items-center justify-content-center">
											<i class="icon-quote-left"></i>
										</span>
									</div>
							...
							<div class="item">
								<div class="testimony-wrap p-4 pb-5">
									<div class="user-img mb-5" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/person_3.jpg)">
										<span class="quote d-flex align-items-center justify-content-center">
											<i class="icon-quote-left"></i>
										</span>
									</div>
		...
		<section class="ftco-gallery">
			<div class="container-wrap">
				<div class="row no-gutters">
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/gallery-1.jpg);">
					...
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/gallery-2.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-search"></span>
							</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/gallery-3.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-search"></span>
							</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="#" class="gallery img d-flex align-items-center" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/gallery-4.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-search"></span>
							</div>
						</a>
				...
				<div class="row">
					<div class="col-md-4 ftco-animate">
						<div class="blog-entry">
							<a href="blog-single.html" class="block-20" style="background-image: url('http://localhost/expresscode/page/assets/templates/default/frontend/images/image_1.jpg');">
							</a>
					...
					<div class="col-md-4 ftco-animate">
						<div class="blog-entry" data-aos-delay="100">
							<a href="blog-single.html" class="block-20" style="background-image: url('http://localhost/expresscode/page/assets/templates/default/frontend/images/image_2.jpg');">
							</a>
							<div class="text d-flex py-4">
								<div class="meta mb-3">
									<div><a href="#">Sep. 20, 2018</a></div>
					...
					<div class="col-md-4 ftco-animate">
						<div class="blog-entry" data-aos-delay="200">
							<a href="blog-single.html" class="block-20" style="background-image: url('http://localhost/expresscode/page/assets/templates/default/frontend/images/image_3.jpg');">
							</a>
							<div class="text d-flex py-4">
								<div class="meta mb-3">
									<div><a href="#">Sep. 20, 2018</a></div>
					...
					<div class="col-md-4 pr-md-4">
						<div class="ftco-footer-widget mb-4">
							...
							<div class="block-21 mb-4 d-flex">
								<a class="blog-img mr-4" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/image_1.jpg);"></a>
								<div class="text">
							...
							<div class="block-21 mb-4 d-flex">
								<a class="blog-img mr-4" style="background-image: url(http://localhost/expresscode/page/assets/templates/default/frontend/images/image_2.jpg);"></a>
								<div class="text">
									<h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
									<div class="meta">
										<div><a href="#"><span class="icon-calendar"></span> Sept 15, 2018</a></div>
