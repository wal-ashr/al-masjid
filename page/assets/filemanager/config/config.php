...
$config = array (
	...
	|
	*/
	'base_url' => ((isset ( $_SERVER ['HTTPS'] ) && $_SERVER ['HTTPS'] == "on") ? "https" : "http") . "://" . @$_SERVER ['HTTP_HOST'] . '/expresscode/public/assets',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'upload_dir' => '/resources/filemanager/source/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../resources/filemanager/source/',
	...
	|
	*/
	'thumbs_base_path' => '../resources/filemanager/source/thumbs/',
	...
	*/
	'files_without_extension' => false,
		 ...
		 * # 4 / crop= resize and crop;
		 */
		'relative_image_creation_option' => array (
				'crop',
				'crop' 
		), // set the type of the crop
